...
{
    public class QuickstartContextSeedData
    {
        private readonly QuickstartContext _context;
        private readonly UserManager<QuickStartUser> _userManager;

        public QuickstartContextSeedData(QuickstartContext context, UserManager<QuickStartUser> userManager)
        {
        ...
        {
            if (await _userManager.FindByEmailAsync("howard@test.com") == null)
            {
                var user = new QuickStartUser()
                {
                    UserName = "howard",
            ...
            if (!_context.Trips.Any())
            {
                var usTrip = new Trip()
                {
                    ...
                    Name = "US Trip",
                    UserName = "howard", // TODO Add UserName
                    Stops = new List<Stop>()
                    {
